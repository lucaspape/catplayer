        ...
        for(i in (0 until loadMax / 50)){
            ...
            val stringRequest = StringRequest(
                ...
                Response.Listener<String> { response ->
                    ...
                    val simpleAdapter = SimpleAdapter(view.context, list, R.layout.list_single, from, to.toIntArray())
                    ...
                    for(k in (0 until jsonArray.length())){
                        ...
                        hashMap.put("coverUrl", view.context.cacheDir.toString() + "/"  + title + version + artist + ".png")
                ...
                val streamHashRequest = StringRequest(
                    ...
                    Response.Listener<String> { response ->
                        ...
                        for(i in (0 until jsonArray.length())){
                            ...
                            if(jsonArray.getJSONObject(i).getString("title") + jsonArray.getJSONObject(i).getString("version") == searchSong){
                                if(jsonArray.getJSONObject(i).getBoolean("streamable")){
                                    ...
                                    Toast.makeText(view.context, "Song not yet streamable!", Toast.LENGTH_SHORT).show()
                        ...
                        if(streamHash != ""){
                            ...
                            Toast.makeText(view.context, itemValue.get("title") as String + " " + itemValue.get("version") as String + " added to playlist!", Toast.LENGTH_SHORT).show()
                        }
